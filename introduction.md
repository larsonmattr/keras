...
### Advice for training Generative Adversarial Networks
- [Keep Calm and train a GAN](https://medium.com/@utk.is.here/keep-calm-and-train-a-gan-pitfalls-and-tips-on-training-generative-adversarial-networks-edd529764aa9)
- [The GAN Zoo](https://deephunt.in/the-gan-zoo-79597dc8c347)

# Dictionary
- convolutional neural network
- layer
- "latent image space" : when images are generated by a random set of parameters, we are exploring the space of images.
...
# GAN Papers
- [Learning Representationsand Generative Models for 3D Point Clouds](https://arxiv.org/pdf/1707.02392.pdf)